...
import { ShoppingCart, X, Menu, Instagram, Facebook, MapPin, Phone, Clock, Home, UtensilsCrossed, CalendarCheck, Building2, Minus, Plus, Trash2, MessageCircle } from "lucide-react";
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-8", children: [
          /* @__PURE__ */ jsxs(Link, { to: "/", className: "group flex flex-col", children: [
            /* @__PURE__ */ jsx("span", { className: "font-display text-2xl font-bold tracking-wide text-warm-white", children: "VILLA BLANCA" }),
            /* @__PURE__ */ jsx("span", { className: "mt-0.5 h-[2px] w-12 bg-ember transition-all group-hover:w-24" })
          ] }),
          /* @__PURE__ */ jsx("nav", { className: "hidden items-center gap-8 lg:flex", children: LINKS.map((l) => {
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  cartCount > 0 && /* @__PURE__ */ jsx("span", { className: "absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-ember text-[10px] font-bold text-warm-white", children: cartCount })
                ]
              }
            ),
            /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs("nav", { className: "flex flex-col px-6 py-6", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxs("footer", { className: "bg-charcoal text-warm-white", children: [
    /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-3 md:px-8", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h3", { className: "font-display text-2xl font-bold", children: "VILLA BLANCA" }),
        /* @__PURE__ */ jsx("p", { className: "mt-3 max-w-xs text-sm text-warm-white/70", children: SITE.tagline }),
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "font-display text-sm font-semibold uppercase tracking-widest text-gold", children: "Navigation" }),
        /* @__PURE__ */ jsxs("ul", { className: "mt-4 space-y-2 text-sm text-warm-white/80", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/", className: "hover:text-ember", children: "Home" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/menu", className: "hover:text-ember", children: "Menu" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/hotel", className: "hover:text-ember", children: "Hôtel" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/evenements", className: "hover:text-ember", children: "Événements" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/contact", className: "hover:text-ember", children: "Contact" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "font-display text-sm font-semibold uppercase tracking-widest text-gold", children: "Contact" }),
        /* @__PURE__ */ jsxs("ul", { className: "mt-4 space-y-3 text-sm text-warm-white/80", children: [
          /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsx(MapPin, { className: "mt-0.5 h-4 w-4 text-ember" }),
            " ",
            SITE.address
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsx(Phone, { className: "mt-0.5 h-4 w-4 text-ember" }),
            " ",
            SITE.phone
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsx(Clock, { className: "mt-0.5 h-4 w-4 text-ember" }),
            " ",
            SITE.hours
          ] })
        ] })
    ...
    /* @__PURE__ */ jsx("div", { className: "border-t border-white/10 py-5 text-center text-xs text-warm-white/50", children: "© 2025 Villa Blanca · Lomé, Togo. Tous droits réservés." })
  ] });
}
const TABS = [
...
function MobileTabBar() {
  const path = useRouterState({ select: (s) => s.location.pathname });
  return /* @__PURE__ */ jsx("nav", { className: "fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-warm-white/95 backdrop-blur md:hidden", children: /* @__PURE__ */ jsx("ul", { className: "grid grid-cols-5", children: TABS.map(({ to, label, Icon }) => {
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      motion.aside,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-border px-6 py-5", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-display text-xl", children: "Votre Commande" }),
            /* @__PURE__ */ jsx("button", { onClick: () => setOpen(false), "aria-label": "Fermer", children: /* @__PURE__ */ jsx(X, { className: "h-5 w-5" }) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto px-6 py-4", children: items.length === 0 ? /* @__PURE__ */ jsx("p", { className: "py-12 text-center text-sm text-muted-foreground", children: "Votre panier est vide." }) : /* @__PURE__ */ jsx("ul", { className: "space-y-4", children: items.map((i) => /* @__PURE__ */ jsxs("li", { className: "flex gap-3 rounded-lg border border-border bg-card p-3", children: [
            i.image && /* @__PURE__ */ jsx(
              "img",
              {
                src: i.image,
                alt: i.name,
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsx("p", { className: "font-medium", children: i.name }),
              /* @__PURE__ */ jsx("p", { className: "font-accent text-sm text-ember", children: fcfa(i.price) }),
              /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "w-6 text-center text-sm", children: i.qty }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    className: "rounded border border-border p-1",
          ...
          items.length > 0 && /* @__PURE__ */ jsxs("div", { className: "border-t border-border bg-card px-6 py-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "Total" }),
              /* @__PURE__ */ jsx("span", { className: "font-accent text-2xl text-ember", children: fcfa(total()) })
            ] }),
            /* @__PURE__ */ jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsx("div", { className: "mb-3 flex gap-2", children: ["Sur place", "Livraison"].map((m) => /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => setMode(m),
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("h1", { className: "font-display text-5xl font-bold tracking-widest text-gold md:text-7xl", children: [
              "VILLA",
              /* @__PURE__ */ jsx("br", {}),
              "BLANCA"
            ] }),
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("p", { className: "mt-6 font-accent text-xs tracking-[0.4em] text-warm-white/70 uppercase", children: "Lomé, Togo" }),
                  /* @__PURE__ */ jsx("div", { className: "mx-auto mt-4 h-[1px] w-12 bg-gold/50" })
                ]
              }
            )
          ]
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsx("h1", { className: "font-display text-7xl font-bold", children: "404" }),
    /* @__PURE__ */ jsx("h2", { className: "mt-4 text-xl", children: "Page introuvable" }),
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsx("h1", { className: "font-display text-xl", children: "Cette page n'a pas pu se charger" }),
    /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Une erreur est survenue. Essayez de rafraîchir." }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxs(QueryClientProvider, { client: queryClient, children: [
    ...
    !standalone && /* @__PURE__ */ jsx(Navbar, {}),
    /* @__PURE__ */ jsx("main", { className: !standalone ? "pb-16 md:pb-0" : "", children: /* @__PURE__ */ jsx(Outlet, {}) }),
    !standalone && /* @__PURE__ */ jsx(Footer, {}),
    !standalone && /* @__PURE__ */ jsx(MobileTabBar, {}),
    /* @__PURE__ */ jsx(CartDrawer, {})
  ] });
}
const $$splitComponentImporter$a = () => import("./reserver-D4htZA5i.js");
...
const $$splitComponentImporter$9 = () => import("./reception-CknhJSV8.js");
...
const $$splitComponentImporter$8 = () => import("./menu-DScIhYVJ.js");
...
const $$splitComponentImporter$7 = () => import("./hotel-CSbivnSX.js");
...
const $$splitComponentImporter$6 = () => import("./gallery-C2jOrOM6.js");
...
const $$splitComponentImporter$5 = () => import("./evenements-BArXCoJK.js");
...
const $$splitComponentImporter$4 = () => import("./contact-Dhcn0c9n.js");
...
const $$splitComponentImporter$3 = () => import("./admin-DlUDjODH.js");
...
const $$splitComponentImporter$2 = () => import("./index-BoguEIdH.js");
...
const $$splitComponentImporter$1 = () => import("./table._tableNumber-CTeww9Yi.js");
...
const $$splitComponentImporter = () => import("./chambre._roomNumber-BdVLYlhB.js");

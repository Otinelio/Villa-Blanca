...
import { u as useCart, f as fcfa } from "./router-1vZrVOI4.js";
const BADGE_COLOR = {
    ...
    motion.article,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col p-5", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-accent text-lg font-bold uppercase", children: item.name }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 flex-1 text-sm text-muted-foreground", children: item.description }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "font-accent text-xl text-ember", children: fcfa(item.price) }),
            /* @__PURE__ */ jsxs(
              motion.button,
              {
                whileTap: { scale: 0.92 },

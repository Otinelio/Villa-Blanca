...
const CalendarCheck = createLucideIcon("calendar-check", __iconNode$B);
const __iconNode$A = [
  ["path", { d: "M8 2v4", key: "1cmpym" }],
  ["path", { d: "M16 2v4", key: "4m81vk" }],
  ["rect", { width: "18", height: "18", x: "3", y: "4", rx: "2", key: "1hopcy" }],
...
const PartyPopper = createLucideIcon("party-popper", __iconNode$e);
const __iconNode$d = [
  [
    "path",
    {
...
const Sandwich = createLucideIcon("sandwich", __iconNode$a);
const __iconNode$9 = [
  [
    "path",
    {
